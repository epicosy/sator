...
from sator.core.deltas.helpers import get_range_offset, get_row_diff_range
from sator.data.parsing import Change


class DiffParser:
    # TODO: rename, not really a labeler, it just extracts the changes and their location in code from patches
    # TODO: should be part of or extend the GitHubHandler
    ...
    def parse_inline_diff(self, change: Change):
        ...
        output = {'type': change.type, 'content': change.content}
